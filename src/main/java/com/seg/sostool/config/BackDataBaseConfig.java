package com.seg.sostool.config;
...
@Data
@Configuration
@ConfigurationProperties(prefix = "back.datasource.druid")//prefix表示读取的配置信息的前缀
...
public class BackDataBaseConfig {
     ...
     * dao层的包路径
     */
    static final String PACKAGE = "com.seg.sostool.dao.back";

    /**
     * mapper文件的相对路径
     */
    private static final String MAPPER_LOCATION = "classpath:mybatis/mapper/back/*.xml";
